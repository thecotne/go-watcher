...
func TestIsTestFile(t *testing.T) {
	fileName := "/go/src/github.com/thecotne/go-watcher/common.go"
	if isTestFile(fileName) {
		t.Error("expected false, got true")
	}

	fileName = "/go/src/github.com/thecotne/go-watcher/common_test.go"
	if !isTestFile(fileName) {
...
func TestIsWatchedFileType(t *testing.T) {
	...
	fileName = "/go/src/github.com/thecotne/go-watcher/README.md"
